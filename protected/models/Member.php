...
class Member extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, gender, address, zipcode, provice_id, username, password, typeuser', 'required'),
			array('zipcode, provice_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, gender, address, zipcode, provice_id, username, password, typeuser', 'safe', 'on'=>'search'),
		);
	}
